...
let package = Package(name: "VLRadialGraphKit",
                      platforms: [ .iOS(.v17) ],
                      products:
                      [
                       .library(name: "VLRadialGraphKit",
                                targets: [ "VLRadialGraphKit" ]),
                      ],
                      dependencies:
                      [
                       .package(url: "https://github.com/VLstack/VLShapeKit.git", 
                                .upToNextMajor(from: "1.1.0"))
                      ],
                      targets:
                      [
                       .target(name: "VLRadialGraphKit",
                               dependencies:
                               [
                                .product(name: "VLShapeKit", package: "VLShapeKit")
                               ]),
                       .testTarget(name: "VLRadialGraphKitTests",
                                   dependencies: [ "VLRadialGraphKit" ])
                      ])
